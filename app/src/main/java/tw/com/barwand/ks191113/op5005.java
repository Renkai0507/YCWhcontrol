...
public class op5005 extends AppCompatActivity {
    RequestQueue mQueue;
    String mUrl = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_op5005);
        ...
        mEdtPdctNo.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                if (i == KeyEvent.KEYCODE_ENTER && keyEvent.getAction() == KeyEvent.ACTION_UP) {
                    ...
                    //{
                    Searchtype = "pdct";
                    Intent it = new Intent(op5005.this,php_search01.class);
...
//                    }
            ...
            case REQUEST_Cust:
                if (mResultCode == Activity.RESULT_OK) {
                    if (Searchtype.equals("pdct"))
                    {
                        ...
                        volley_post_search_stock(mEdtWhNo.getText().toString());
                        mEdtWhNo.requestFocus();
                        mEdtWhNo.selectAll();
                    }
    ...
    private void volley_post_search_stock(final String str_bar_data) {
        ...
        //final String PH=medtInput.getText().toString().split(";")[1];
        OutputData = "";
        mUrl="http://" + fstrIP + ":" +fstrPort + "/ycworksys/yc_search_wh_stock.php";
    ...
    public void showJson(String response)
    {
        ...
        try {
            ...
            op5005_Adapter adapter= new op5005_Adapter(libstNo,inflater);
...
//            listResult.setAdapter(listAdapter);
    ...
    private String[] parseJSONData(JSONArray dataInput) {
        ...
        try {
            ...
            String[] lib_NAME2 = new String[dataInput.length()];
