...
public class op5002 extends AppCompatActivity {
    RequestQueue mQueue;
    String mUrl = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_op5002);
...
//                    {
                        ...
                        Searchtype="wh";
                        Intent it = new Intent(op5002.this,php_search01.class);
...
//        });
        ...
        mBtnSearch02.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mEdtWhNo.getText().toString().equals("") || mEdtPdctNo.getText().toString().equals("") || mEdtQty.getText().toString().equals("") )
                {
                    Errbeep(getApplicationContext(),"儲位、品號、實盤數量不可空，請確認!!",1000,true,1000);
                }else
                {
                    Intent it = new Intent(op5002.this,php_search01.class);
...
//        mEdtInAprt.requestFocus();
    ...
    private void volley_post_insert(final String str_wh,final String str_pdct,final String str_qty,final String str_chk_qty,final String str_note) {
        ...
        //final String PH=medtInput.getText().toString().split(";")[1];
        OutputData = "";
        mUrl="http://" + fstrIP + ":" +fstrPort + "/ycworksys/yc_insert_countmast.php";
