...
public class op5001_1 extends AppCompatActivity {
    RequestQueue mQueue;
    String mUrl = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_op5001_1);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            String stMsg =new JSONArray(response).getJSONObject(i-1).getString("OUTPUT");
                             ...
                             if (stMsg.equals("OK"))
                            {
                                String stPdctName1 =new JSONArray(response).getJSONObject(i-1).getString("Item01"); //品名一
                                String stPdctName2 =new JSONArray(response).getJSONObject(i-1).getString("Item02");//品名二
                                String stUnit =new JSONArray(response).getJSONObject(i-1).getString("Item03");//單位
                                String stSafeQty =new JSONArray(response).getJSONObject(i-1).getString("Item04");//安全庫存
                                String stNowQty =new JSONArray(response).getJSONObject(i-1).getString("Item05");//現有庫存
    ...
    private void volley_post_update(final String str_UpdQty) {
        ...
        mGetRequest = new  StringRequest(Request.Method.POST, mUrl,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String,String> params = new Hashtable<String, String>();
                params.put("stUpdTable", "out_mast");
